...
public class GarageDoorSensor extends Sensor
{
    public static final DeviceClass DEVICE_CLASS = DeviceClass.GARAGE_DOOR_SENSOR;

    public GarageDoorSensor(final String deviceId, final String bindingId, final String deviceName,
