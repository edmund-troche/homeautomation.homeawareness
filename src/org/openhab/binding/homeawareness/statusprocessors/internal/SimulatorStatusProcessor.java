...
import org.openhab.binding.homeawareness.internal.SensorStatusProcessor;

public class SimulatorStatusProcessor implements SensorStatusProcessor {
    ...
    private Thread baseStation = new Thread("HHB Base Station");

    private class HhbBaseStationSimulator implements Runnable {
